...
const services = [
	{ icon: FaBuilding, label: 'Construction', href: '/services/construction' },
	{ icon: FaHome, label: 'Real Estate', href: '/services/real-estate' },
	{ icon: FaTools, label: 'Hardware Supplies', href: '/services/hardware' },
];
		...
		<div className="relative h-screen flex items-center overflow-hidden">
			...
			<div className="container mx-auto px-4 relative z-10">
				<div className="max-w-4xl mx-auto text-center">
					...
					>
						Comprehensive solutions in Construction, Real Estate, and
						Hardware, tailored for Rwanda's growth.
					</motion.p>
					...
					>
						{services.map(({ icon: Icon, label, href }) => (
							<motion.div
								...
								className="backdrop-blur-md bg-white/10 p-6 rounded-slight hover:bg-white/20 transition-all duration-300 border border-white/10 group cursor-pointer"
